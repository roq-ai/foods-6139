...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'restaurant-manager', 'delivery-driver'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Delivery', path: '/deliveries', entity: 'delivery', service: AccessServiceEnum.PROJECT, icon: FiTruck },
